...
public class Message implements Cloneable {
    ...
    public Message clone() {
        try {
            ObjectForMessage objM = new ObjectForMessage();
            objM.setData(List.copyOf(this.getField13().getData()));
            Message clone =  (Message) super.clone();
            Field field = clone.getClass().getDeclaredField("field13");
            field.setAccessible(true);
            field.set(clone,objM);
            return clone;
