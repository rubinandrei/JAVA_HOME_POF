package ru.otus.rubin.home.base;
...
import ru.otus.rubin.home.core.repository.DataTemplateHibernate;
import ru.otus.rubin.home.core.repository.HibernateUtils;
import ru.otus.rubin.home.core.sessionmanager.TransactionManagerHibernate;
import ru.otus.rubin.home.crm.dbmigrations.MigrationsExecutorFlyway;
import ru.otus.rubin.home.crm.model.Address;
import ru.otus.rubin.home.crm.model.Client;
import ru.otus.rubin.home.crm.model.Phone;
import ru.otus.rubin.home.crm.service.DBServiceClient;
import ru.otus.rubin.home.crm.service.DbServiceClientImpl;

import static ru.otus.rubin.home.demo.DbServiceDemo.HIBERNATE_CFG_FILE;
